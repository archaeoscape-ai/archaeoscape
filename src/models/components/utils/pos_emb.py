...
from src.models.components.utils import SimpleSegmentationHead, infer_output, load_state_dict
...
# --------------------------------------------------------
# 2D sine-cosine position embedding with resolution
# References:
# Scale MAE: https://github.com/bair-climate-initiative/scale-mae/blob/main/mae/util/pos_embed.py
# --------------------------------------------------------
